                            ...
                            <div class="ticket-info-section">
                                <table class="table table-borderless mb-0 ticket-detail-table">
                                    ...
                                    <tr id="d_row_pending_notes" class="d-none">
                                        ...
                                        <td class="w-100">
                                            <div id="d_pending_notes" class="text-muted fst-italic bg-warning p-2 rounded border border-warning" style="--bs-bg-opacity: .1; max-width: 100%; display: block; white-space: normal !important; word-wrap: break-word; overflow-wrap: break-word;">No reason provided</div>
                                        </td>
                                    </tr>
                                    <tr id="d_row_notes" class="d-none">
                                        <th class="text-muted align-top">Resolution Notes</th>
                                        <td class="w-100">
                                            <div id="d_notes" class="text-muted fst-italic bg-light p-2 rounded border" style="max-width: 100%; display: block; white-space: normal !important; word-wrap: break-word; overflow-wrap: break-word;">No notes available</div>
                                        </td>
                                    </tr>
                                    <tr>
