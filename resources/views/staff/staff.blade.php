...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body p-4">
        <h5 class="fw-bold mb-3"><i class="fas fa-bullhorn text-primary me-2"></i>Announcements & News</h5>
        @if($news->count() > 0)
                ...
                <div class="d-flex align-items-center justify-content-between p-3 border rounded-3 hover-shadow-sm" 
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <small class="text-muted"><i class="far fa-clock me-1"></i>{{ \Carbon\Carbon::parse($item->created_at)->diffForHumans() }}</small>
                        </div>
                    </div>
                </div>
                @endforeach
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 ps-lg-4 mt-4 mt-lg-0">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h6 class="mb-0 fw-bold text-dark"><i class="fas fa-history text-muted me-2"></i>Your Latest Tickets</h6>
                        </div>
