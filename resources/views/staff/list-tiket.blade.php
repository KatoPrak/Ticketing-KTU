            ...
            <div class="modal-body">
                ...
                <div id="d_content" class="d-none">
                    <table class="table table-borderless">
                        <tr><th>Ticket ID</th><td id="d_ticket_id"></td></tr>
                        <tr><th>Description</th><td id="d_description" style="white-space: pre-wrap;"></td></tr>
                        <tr><th>Category</th><td id="d_category"></td></tr>
                        <tr><th>User</th><td id="d_user"></td></tr>
                        <tr><th>Created</th><td id="d_created"></td></tr>
                        <tr><th>Status</th><td><span id="d_status" class="badge rounded-pill px-3 py-2"></span></td></tr>
                        <tr><th>Priority</th><td><span id="d_priority" class="badge rounded-pill px-3 py-2"></span></td></tr>
                        <tr><th>Attachments</th><td id="d_attachments"></td></tr>
                        <tr id="d_row_notes" class="d-none"><th>Notes</th><td id="d_notes"></td></tr>
                    </table>
                </div>
            </div>
