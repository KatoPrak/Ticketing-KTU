...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (createForm) {
        console.log('✅ Found create ticket form, attaching handler...');
        ...
        createForm.addEventListener('submit', async function(e) {
            ...
            try {
                ...
                console.log('📤 Submitting ticket from ticket list page...');
        ...
        console.log('❌ Create ticket form not found in ticket list page');
    }
