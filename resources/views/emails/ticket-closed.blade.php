...
<head>
    ...
    <style>
        ...
        .header-title { background: linear-gradient(135deg, #1e7e34 0%, #28a745 100%); padding: 22px 20px; text-align: center; }
        ...
        /* ── BODY ── */
        .body { padding: 30px; }
        .ticket-info { background-color: #f8f9fa; border-left: 4px solid #28a745; padding: 20px; margin: 20px 0; border-radius: 6px; }
        .ticket-info h2 { margin: 0 0 15px 0; color: #1e7e34; font-size: 16px; }
        ...
        .solution-box { background-color: #e7f5ff; border: 1px solid #339af0; border-radius: 6px; padding: 16px; margin: 20px 0; }
        .solution-box h3 { margin: 0 0 8px 0; color: #1971c2; font-size: 15px; }
        .solution-box p { margin: 0; color: #495057; line-height: 1.6; }
        .status-badge { display: inline-block; background-color: #28a745; color: white; padding: 5px 12px; border-radius: 4px; font-size: 13px; font-weight: 700; }
...
<body>
    <div class="container">
        ...
        <div class="header-title">
            <h1>✅ Ticket Closed</h1>
            <p>Your issue has been successfully resolved by the IT Team</p>
        </div>

        {{-- ── BODY ── --}}
        <div class="body">
            <p>Hello <strong>{{ $ticket->user->name ?? 'User' }}</strong>,</p>
            <p style="color:#495057;">We would like to inform you that your ticket has been <strong>closed</strong>. Here is the summary of the resolution:</p>

            <div class="ticket-info">
                <h2>📋 Ticket Information</h2>
                <div class="info-row">
                    <div class="info-label">Ticket ID</div>
                    <div class="info-value"><strong style="color:#1a2e5a; font-family:monospace;">{{ $ticket->ticket_id ?? '#'.$ticket->id }}</strong></div>
                </div>
                <div class="info-row">
                    <div class="info-label">Description</div>
                    <div class="info-value">{{ Str::limit($ticket->description, 120) }}</div>
                </div>
                <div class="info-row">
                ...
                <div class="info-row">
                    <div class="info-label">Date Closed</div>
                ...
                <div class="info-row">
                    ...
                    <div class="info-value"><span class="status-badge">CLOSED</span></div>
                </div>
            </div>

            @if($solution)
            <div class="solution-box">
                <h3>💡 Solution &amp; Resolution</h3>
                <p>{{ $solution }}</p>
            </div>
            @endif

            <p style="margin-top:20px; color:#495057; line-height:1.6; font-size:14px;">
                Thank you for using KTU Shipyard IT Support services. If you still encounter issues or have any questions, please do not hesitate to create a new ticket.
            </p>

            <div style="text-align:center;">
                <a href="{{ config('app.url') }}" class="btn">🏠 Return to Dashboard</a>
            </div>
        </div>
